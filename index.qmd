...
This initiative aims to **improve knowledge and application of tools, approaches, and models** that are appropriate at a Canadian scale for looking at how to address challenges such as **conservation of biodiversity, carbon storage and traditional food security** to support the establishment, active management and restoration of protected and conserved areas in the **Hudson--James Bay Lowlands (HJBL).**
...
In this initiative, Parks Canada is asking GEO BON international community **WHAT frameworks, models and tools HAVE SUCCESSFULLY WORKED** in terms of [informing decision making and policy to protect, manage and monitor]{.underline} *biodiversity, ecosystem services (i.e., carbon storage) and traditional food security*. Moreover, **WHAT DOES NOT WORK and WHY?**
...
-   **Ecosystem services**: there are some preliminary priorities to explore within the wide range of ecological services :
    ...
    -   **Traditional food security**: there are some traditional food priorities for indigenous and local communities to explore: freshwater fisheries, berries and geese.
